...
?>
    ...
    <div class="addLazyloadCss">
      ...
      <section id="sect-faq">
        ...
        <div class="faq-container">
          ...
          <p>A. "何か"のイベントへのカウントダウン？ というのだそうだ。
            <br />このままカウントダウンしていくと10/6（土）に0になるよ！　もしかしたら今年も「幕張が〜で〜ん」があるのかも！
          </p>
          ...
          <p>A.
            <span class="red-text">大丈夫！</span> 今年は"ビア"グラスです！
            <br />ただビールサーバとサイズが合わないため、グラスをビールサーバに向かって横向きにずらして注ぎましょう。
          </p>
      ...
      <section id="sect-first">
        ...
        <h5>とりあえずどんな流れか知りたい方プラン</h5>
        <ol class="countlist root-ol" style="margin-bottom: 2em;">
          <li>持ち物を確認しよう
            <ol class="countlist">
              <li>お金（射的やクレーンゲーム、物販に行く方は多めにね！）</li>
              <li>クリアファイル（もらったスタンプラリーシートなどを仕舞う用。物販で買ってもよし）</li>
              <li>けもフレを好きな気持ち（話題なんかなくったっていいんだよ！）</li>
            </ol>
          </li>
          <li>チケットを取りましょう！
            <ol class="countlist">
              <li>土日祝で行く方は楽天チケットにて予約を取りましょう。
                <a href="https://ticket.rakuten.co.jp/search/result/freeword?q=%E3%81%91%E3%82%82%E3%81%AE%E3%83%95%E3%83%AC%E3%83%B3%E3%82%BA%E3%81%8C%E3%83%BC%E3%81%A7%E3%82%93"
                  rel="external" title="rakuten ticket">楽天チケットはこちらから</a>
                <a href="https://twitter.com/kemono_matsuri/status/1012532300918095873" rel="external">公式Twitterの告知ツイート</a>

              </li>
              <li>平日に行く方は直接現地へ行きましょう。当日整理券をもらう必要があります。</li>
              <li>お盆期間中（8/13〜15）は平日でも予約扱いです。土日祝でも、予約が売り切れていない部分について当日整理券発行があります。状況は公式Twitterで確認しましょう。</li>
              <li>当日整理券は
                <span class="red-text">楽園タウンビル横の路地</span>に整列してお待ちください。スタッフが配布、誘導に来ます。
                <br />※一般の往来のある場所です！節度を持った行動を！
              </li>
              <li>当日整理券には入る時間が書かれています。入りたい時間の券をもらいましょう。</li>
              <li>当日整理券の支払いは入場時です。現金のみなのでご用意をお忘れなく！</li>
              <div class="flex-container">
                <div class="flex-item">
                  <figure>
                    <img src="img/other/gardenTicket-min.png" class="responsive-img" alt="当日整理券" />
                    <figcaption>当日整理券
                      <a href="img/other/gardenTicket.png" title="100%" rel="nofollow">
                        <i class="fas fa-expand-arrows-alt"></i>
                      </a>
                    </figcaption>
                  </figure>
                ...
                <div class="flex-item">
                  <figure>
                    <img src="img/other/waitingPlace-min.png" class="responsive-img" alt="待機場" />
                    <figcaption>待機列形成場所（入り口向かって左の横の路地）
                      <a href="img/other/waitingPlace.png" title="100%" rel="nofollow">
                        <i class="fas fa-expand-arrows-alt"></i>
                      </a>
                    </figcaption>
                  </figure>
          ...
          <li>入場しましょう！
            <ol class="countlist">
              <li>整理券、予約券の時間10分前になったら指定の待機列形成場所（スタッフさんや1階立て看板の指示に従って、蕎麦屋横の路地あるいは屋上）に並んで下さい。</li>
              <li>夜営業の遅い回では直接入場して入れる場合もあります。
                <a href="https://twitter.com/kemono_matsuri" rel="external" title="Twitter">公式Twitter

                </a>を確認しましょう</li>
              <li>楽天チケットの予約券を出すか、当日整理券を出しましょう。</li>
              <li>当日整理券の方は現金でお支払いです。</li>
              <li>入場時にもらうものがあります。全部もらっているか確認しましょう。
                <a href="#sect-present" title="入場時配布物" rel="nofollow">◉ここをみるのだ！</a>
              </li>
              <li>ジョッキを買わない方は入る際に貸しジョッキを受け取りましょう！</li>
              <li>初めての方はすでにスタンプカードにスタンプが押してありますので、そのままバッグにしまって大丈夫です。</li>
              <li>リストバンドは必ずつけましょう！スタッフの方の目印になっています。見えるようにね！</li>
              <li>お通しは物によっては早く食べた方がいいものもあります。</li>
            </ol>
          </li>
          <li>席につこう！
            <ol class="countlist">
              <li>自由席で相席です。お互いに譲り合って座りましょう。混み合いますのでなるべく一席で！</li>
              <li>立席もあります。座るのが面倒ならそちらに行くのも良いでしょう。</li>
              <div class="flex-container">
                <div class="flex-item">
                  <figure>
                    <img src="img/other/gardenTable-min.png" class="responsive-img" alt="テーブル席" />
                    <figcaption>テーブル席
                      <a href="img/other/gardenTable.png" title="100%" rel="nofollow">
                        <i class="fas fa-expand-arrows-alt"></i>
                      </a>
                    </figcaption>
                  </figure>
                ...
                <div class="flex-item">
                  <figure>
                    <img src="img/other/beachParasol-min.png" class="responsive-img" alt="テーブル席2" />
                    <figcaption>テーブル席（夜, パラソル）
                      <a href="img/other/beachParasol.png" title="100%" rel="nofollow">
                        <i class="fas fa-expand-arrows-alt"></i>
                      </a>
                    </figcaption>
                  </figure>
                ...
                <div class="flex-item">
                  <figure>
                    <img src="img/other/standingRoom-min.png" class="responsive-img" alt="立席" />
                    <figcaption>立席
                      <a href="img/other/standingRoom.png" title="100%" rel="nofollow">
                        <i class="fas fa-expand-arrows-alt"></i>
                      </a>
                    </figcaption>
                  </figure>
              ...
              <li>クロークはありません。自己責任で荷物を管理しましょう！</li>
            </ol>
          </li>
          <li>飲み物を用意しよう！
            <ol class="countlist">
              <li>飲み物は会場中央にあります。サーバの飲み物を自分で用意するスタイルです。
                <div class="flex-container">
                  <div class="flex-item">
                    <figure>
                      <img src="img/other/drinkServerAppearance-min.png" class="responsive-img" alt="ドリンクサーバ外観" />
                      <figcaption>ドリンクサーバ外観
                        <a href="img/other/drinkServerAppearance.png" title="100%" rel="nofollow">
                          <i class="fas fa-expand-arrows-alt"></i>
                        </a>
                      </figcaption>
                    </figure>
                  ...
                  <div class="flex-item">
                    <figure>
                      <img src="img/other/drinkServer-min.png" class="responsive-img" alt="ドリンクサーバ（左）" />
                      <figcaption>ドリンクサーバ（左）
                        <a href="img/other/drinkServer.png" title="100%" rel="nofollow">
                          <i class="fas fa-expand-arrows-alt"></i>
                        </a>
                      </figcaption>
                    </figure>
                  ...
                  <div class="flex-item">
                    <figure>
                      <img src="img/other/drinkServer2-min.png" class="responsive-img" alt="ドリンクサーバ（右）" />
                      <figcaption>ドリンクサーバ（右）
                        <a href="img/other/drinkServer2.png" title="100%" rel="nofollow">
                          <i class="fas fa-expand-arrows-alt"></i>
                        </a>
                      </figcaption>
                    </figure>
              ...
              <li>会場中央のサーバの飲み物は飲み放題です。飲みすぎないように水も飲もうね！</li>
              <li>ジョッキがない方は、入場時に貸しジョッキをもらうか、物販で購入しましょう。</li>
              <li>ビールは「アサヒビール」です。宗教上アサヒビールが飲めない方はハイボールなど他のアルコールもあります。</li>
            </ol>
          </li>
          <li>静かに、または近くの人と乾杯しよう！
            <ol class="countlist">
              <li>一人で飲んでも全然問題ないです。でも、もし誰かとお話ししたくなったらジョッキを持って乾杯しに行きましょう！</li>
              <li>フレンズの皆さんは大抵乾杯してくれますし、そのあとあなたとお話ししたいと思っています。</li>
              <li>わいわいするのが苦手な方は他の人を眺めているのも。でもコスプレしているスタッフの方は声をかけてくるかもね。</li>
            </ol>
          </li>
          <li>屋台のご飯やコラボドリンクを飲んでみよう！
            <ol class="countlist">
              <li>フレンズをイメージしたドリンクがフードチケット500円（現金使用不可）で販売しています。一杯につき1枚コースターがついてきます。</li>
              <li>屋台にもサーバルちゃんのオムライスみたいにおもろ美味しい食べ物があります。試して見てはいかがでしょう。</li>
              <li>大抵の場合、写真に撮って「わーい！」ってツイートするといいねがもらえます。 ...たぶんね</li>
            </ol>
          </li>
          <li>射的、ジャパまん投げにチャレンジしよう
            <ol class="countlist">
              <li>フードチケット500円でできます。（現金使用不可）</li>
              <li>難易度は時たま変わるので時々チャレンジしてみよう！</li>
              <li>成功するとスタンドパネルもらえるよ。</li>
              <li>それなりに混むので順番を守ろうね。</li>
            </ol>
          </li>
          <li>フードチケットが足りなくなっちゃった！
            <ol class="countlist">
              <li>安心してください。受付で買えますよ！</li>
              <li>フードチケットは500円から交換できます</li>
              <li>換金はできません。フードチケットは余ってもそのまま持ち帰って次回使えます。無理に使い切る必要はありません。</li>
            </ol>
          </li>
          <li>コースター、射的、ジャパまん投げ景品をトレードしてみよう！
            <ol class="countlist">
              <li>自分の推しキャラが来なくても大丈夫！持っている人に交換をお願いしてみよう！</li>
              <li>大抵の場合その人は（なぜか）大量にコースター（景品）を持ってます。</li>
              <li>どんだけ財布スターを消費したかはいわゆる禁則事項ってやつです。</li>
            </ol>
          </li>
          <li>スタンプラリーにチャレンジ！
            <ol class="countlist">
              <li>1枠につき一回、スタンプラリーシートにスタンプを押せます。</li>
              <li>6個集まると粗品がもらえます！</li>
              <li>場所は毎日、スタンプ柄は2週間で変わります！</li>
            </ol>
          </li>
          <li>お土産を買おう！
            <ol class="countlist">
              <li>ジョッキだけでなくいろんな商品が販売されています。</li>
              <li>人気の商品は品切れになっていることもあります。</li>
              <li>割れ物は取り扱いに注意です！物販スタッフに言えばプチプチ（緩衝材）もらえます！</li>
            </ol>
          </li>
          <li>お家に帰った後はTwitter上で
            <a href="https://twitter.com/search?q=%23%E8%87%AA%E5%AE%85%E3%81%8C%E3%83%BC%E3%81%A7%E3%82%93&src=typd" rel="external"
              title="自宅がーでんTwitter">#自宅がーでん</a> を楽しんでみてはいかがでしょうか！</li>
          </li>
        </ol>
        <h6>※ここに注意だよ！</h6>
        <ul class="dot-list">
          <li class="red-text bold">トイレは会場内にはありません！4階のトイレを使用してください（リストバンドが無いと再入場できないよ！）</li>
          <li>入場時間は120分、そのうち飲み放題は
            <span class="red-text">飲み物、食べ物共に</span>90分(30分前ラストオーダー)です。残り30分で消費できる量をオーダーしましょう。</li>
          <li>席にビーチパラソルが追加されました。</li>
          <li>運が良いとイベントに立ち会えます
            <ul class="dot-list" style="padding-left: 1em;">
              <li>和太鼓演奏</li>
              <li>声優さんがくるかも（撮影はNGですよ！）</li>
              <li>もりのおんがくかいの演奏（去年）</li>
              <li>セルリアン登場（去年）</li>
            </ul>
          </li>
          <li>コスプレをしたスタッフに出会えるかも⁈ ※一般のコスプレイヤーもいます。
            <span class="red-text">撮影とネットへのアップは相手の許可を取ってから！</span>
          </li>
          <li>「○○色のリストバンドの方はラストオーダーです！」とスタッフの方が声をかけてくれます。指示に従ってね。</li>
          <li>家に無事帰るまでががーでんです。途中で倒れたり寝てしまったりしないように！</li>
          <li>池袋は決して完全に安全な街ではありません。酔った勢いで危険に足を突っ込まないように！</li>
        </ul>
      </section>
      ...
      <section id="sect-changed">
        ...
        <p>昨年の入場券は3,000円にジョッキまたはグラス、および1,000円分のフードチケットがついていました。
          <br />今年は3,500円でお通し付きの小鉢と1,000円分のフードチケットです。(初参加者であれば)ジョッキを別途購入するため実質5,000円(2,000円弱の値上げに相当)です。
        </p>
        <p>ジョッキやグラスはイベントスペース最奥物販コーナーにて購入
          <br />ジョッキは1日1個限定、グラスは購入制限なし</p>
        <p>ジョッキを持参して来ていない参加者へは貸しジョッキあり（物販ジョッキを購入推奨）</p>
        <p>星のついた昨年の500円フードチケットは、今年(2期)のフードチケットと交換になります</p>
      </section>
