  ...
  data: function () {
    return {
      foodGroceryList: [
        ...
        { id: 30, name: 'オニオンスープ [500円]', rel: defaultValue.internal.rel, alt: 'food', src: 'img/foods/gardenOnionSoup-min.png', srcparent: 'img/foods/gardenOnionSoup-min.png', icon: defaultValue.internal.icon },
        { id: 31, name: 'コーンスープ [500円]', rel: defaultValue.internal.rel, alt: 'food', src: 'img/foods/gardenCornSoup-min.png', srcparent: 'img/foods/gardenCornSoup.png', icon: defaultValue.internal.icon },
        { id: 32, name: 'ホットココア [500円]', rel: defaultValue.internal.rel, alt: 'food', src: 'img/foods/gardenCocoa-min.png', srcparent: 'img/foods/gardenCocoa.png', icon: defaultValue.internal.icon },
        { id: 33, name: '熱燗（日本酒/紙コップで提供）[500円]', rel: defaultValue.internal.rel, alt: 'food', src: 'img/foods/gardenAtsukan-min.png', srcparent: 'img/foods/gardenAtsukan.png', icon: defaultValue.internal.icon },
