  ...
  data: function () {
    return {
      foodGroceryList: [
        ...
        { id: 2, name: 'アライグマのブルーベリーヨーグルト', rel: defaultValue.internal.rel, alt: 'food', title: defaultValue.internal.title, src: 'img/foods/araiBlueberryYogurt.png', srcparent: 'img/foods/araiBlueberryYogurt.png', icon: defaultValue.internal.icon },
        { id: 3, name: 'PPPのミルクコーヒー', rel: defaultValue.internal.rel, alt: 'food', title: defaultValue.internal.title, src: 'img/foods/PPPMilkCoffee.png', srcparent: 'img/foods/PPPMilkCoffee.png', icon: defaultValue.internal.icon },
        { id: 4, name: 'ツチノコのショコララテ', rel: defaultValue.internal.rel, alt: 'food', title: defaultValue.internal.title, src: 'img/foods/tsuchinokoChocolatLatte.png', srcparent: 'img/foods/tsuchinokoChocolatLatte.png', icon: defaultValue.internal.icon },
        { id: 5, name: 'リョコウバトのストロベリーカルピス', rel: defaultValue.internal.rel, alt: 'food', title: defaultValue.internal.title, src: 'img/foods/ryokouStrawberryCalpis.png', srcparent: 'img/foods/ryokouStrawberryCalpis.png', icon: defaultValue.internal.icon },
