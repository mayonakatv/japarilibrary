...
var gardengoods = new Vue({
  ...
  data: function () {
    return {
      foodGroceryList: [
        { id: 0, name: 'Food [各種 500円]', rel: '', alt: 'food', src: '', srcparent: '', icon: '' },
        ...
        { id: 6, name: 'Food [各種 300円]', rel: '', alt: 'food', src: '', srcparent: '', icon: '' },
        ...
        { id: 10, name: 'Food [各種 1,000円]', rel: '', alt: 'food', src: '', srcparent: '', icon: '' },
        ...
        { id: 14, name: 'Drink [各種 500円]', rel: '', alt: 'food', src: '', srcparent: '', icon: '' },
        { id: 15, name: 'サーバルのチョコバナナミルク', rel: defaultValue.external.rel, alt: 'food', title: defaultValue.external.title, src: 'https://pbs.twimg.com/media/Djbs3LgU0AAgB-r.jpg', srcparent: 'https://twitter.com/mamedaikichi/status/1024266419695964160', icon: '' },
        ...
        { id: 22, name: 'セルリアンかき氷・青', rel: 'v', alt: 'food', title: defaultValue.external.title, src: 'https://pbs.twimg.com/media/DjcdunWVAAAR87Y.jpg', srcparent: 'https://twitter.com/htktkgt/status/1024320136356843520', icon: defaultValue.external.icon },
