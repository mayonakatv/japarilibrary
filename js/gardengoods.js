  ...
  data: function () {
    return {
      ...
      shatekiGroceryList: [
        ...
        { id: 27, name: 'マーゲイ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 28, name: 'サバンナシマウマ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 29, name: 'カバ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 31, name: 'コツメカワウソ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 32, name: 'ジャガー', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 33, name: 'フォッサ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 34, name: 'アメリカビーバー', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 35, name: 'オグロプレーリードッグ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 36, name: 'トキ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 37, name: 'アルパカ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 38, name: 'ツチノコ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 39, name: 'ヘラジカ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 40, name: 'ライオン', rel: defaultValue.internal.rel, alt: 'shateki', title: defaultValue.internal.title, src: 'img/shateki/p_lion-min.png', srcparent: 'img/shateki/p_lion.png', icon: defaultValue.internal.icon },
        { id: 41, name: 'ハシビロコウ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 42, name: 'アフリオオコノハズク', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 43, name: 'ワシミミズク', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 44, name: 'ギンギツネ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 45, name: 'キタキツネ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 46, name: 'アミメキリン', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 47, name: 'タイリクオオカミ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 48, name: 'アードウルフ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 49, name: 'コンゴウインコ', rel: defaultValue.internal.rel, title: defaultValue.internal.title, src: 'img/shateki/p_kongouinko-min.png', srcparent: 'img/shateki/p_kongouinko.png', icon: defaultValue.internal.icon },
        { id: 50, name: 'パフィン', rel: defaultValue.internal.rel, title: defaultValue.internal.title, src: 'img/shateki/p_puffin-min.png', srcparent: 'img/shateki/p_puffin.png', icon: defaultValue.internal.icon },
        { id: 51, name: 'コモドドラゴン', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 52, name: 'ハクトウワシ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 53, name: 'ピューマ', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
        { id: 53, name: 'ケツァール', rel: '', alt: '', title: '', src: '', srcparent: '', icon: '' },
